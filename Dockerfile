...
RUN conda run -n nasqar_env R -e "install.packages(c('V8'), repos='https://cran.nyuad.nyu.edu/')"
RUN conda run -n nasqar_env R -e "install.packages(c('sodium', 'Seurat'), repos ='https://cran.nyuad.nyu.edu/')"
